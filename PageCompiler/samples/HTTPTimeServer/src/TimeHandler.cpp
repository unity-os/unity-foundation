...
void TimeHandler::handleRequest(Poco::Net::HTTPServerRequest& request, Poco::Net::HTTPServerResponse& response)
{
	...
	responseStream << "\n";
	responseStream << "";
#line 6 "/mnt/c/workspace/flightplan/PageCompiler/samples/HTTPTimeServer/src/TimeHandler.cpsp"
...
#line 16 "/mnt/c/workspace/flightplan/PageCompiler/samples/HTTPTimeServer/src/TimeHandler.cpsp"
	responseStream << ( dt );
	responseStream << "</p>\n";
	responseStream << "</body>\n";
	responseStream << "</html>\n";
